...
"""
This file is adopted from the original implementation from the GraphGPS paper 
...
def set_dataset_splits(dataset, splits):
    ...
    Args:
        ...
        splits: List of train/val/test split indices，containing 3 lists，and each list indicates indexes of train/val/test.
