...
import nsgnn  # register custom modules
from nsgnn.agg_runs import agg_runs
from nsgnn.optimizer.extra_optimizers import ExtendedSchedulerConfig
...
from nsgnn.finetuning import load_pretrained_model_cfg, \
    init_model_from_pretrained
from nsgnn.logger import create_logger
import argparse
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mark_done', action='store_true', default=False,
